...
import DAL.GraficaConteneviaDal;
...
import org.zkoss.zul.Div;
  ...
  public class GraficaConteneviaCtrl extends GenericForwardComposer {
    ...
    public void Grafica1(String Fecha_inicial, String Fecha_final) throws SQLException {
        GraficaConteneviaDal dataBase = new GraficaConteneviaDal();

        grafica1.setType("column");
        grafica1.setTitle("Contenedores por via Directa");
        ...
        List<GraficaConteneviaMd> data = dataBase.Grafica1(Fecha_inicial, Fecha_final);
        String categoria = "";

        int i = 0;
        
        for (GraficaConteneviaMd valor : data) {
            if (categoria.equals("")) {
                categoria = "'" + valor.getContenevia()+ "'";
            } else {
                categoria = categoria + "," + "'" + valor.getContenevia()+ "'";
            }
            model.addValue("Total de Contenedores por Via Directa", i, Integer.parseInt(valor.getSumacontenevia()));
              i++;
        }
    ...
    public void Grafica2(String fecha_inicial, String fecha_final) throws SQLException {
        ...
        grafica2.setTitle("PORCENTAJE CONTENEDORES POR VIA DIRECTA");
