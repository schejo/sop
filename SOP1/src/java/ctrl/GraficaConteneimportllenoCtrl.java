...
import DAL.GraficaConteneimportllenoDal;
...
import org.zkoss.zul.Div;
  ...
  public class GraficaConteneimportllenoCtrl extends GenericForwardComposer {
    ...
    public void Grafica1(String Fecha_inicial, String Fecha_final) throws SQLException {
        GraficaConteneimportllenoDal dataBase = new GraficaConteneimportllenoDal();

        grafica1.setType("column");
        grafica1.setTitle("Contenedores de Importacion Llenos");
        ...
        List<GraficaConteneimportllenoMd> data = dataBase.Grafica1(Fecha_inicial, Fecha_final);
        String categoria = "";

        int i = 0;
        
        for (GraficaConteneimportllenoMd valor : data) {
            if (categoria.equals("")) {
                categoria = "'" + valor.getContenelleno()+ "'";
            } else {
                categoria = categoria + "," + "'" + valor.getContenelleno()+ "'";
            }
            model.addValue("Total Contenedores Llenos", i, Integer.parseInt(valor.getSumcontenelleno()));
              i++;
        }
    ...
    public void Grafica2(String fecha_inicial, String fecha_final) throws SQLException {
        ...
        grafica2.setTitle("PORCENTAJE CONTENEDORES LLENOS");
