...
import DAL.GraficaConteneimportbuqueDal;
...
import org.zkoss.zul.Div;
  ...
  public class GraficaConteneimportbuqueCtrl extends GenericForwardComposer {
    ...
    public void Grafica1(String Fecha_inicial, String Fecha_final) throws SQLException {
        GraficaConteneimportbuqueDal dataBase = new GraficaConteneimportbuqueDal();

        grafica1.setType("column");
        grafica1.setTitle("Contenedores de Importacion por Buque");
        ...
        List<GraficaConteneimportbuqueMd> data = dataBase.Grafica1(Fecha_inicial, Fecha_final);
        String categoria = "";

        int i = 0;
        
        for (GraficaConteneimportbuqueMd valor : data) {
            if (categoria.equals("")) {
                categoria = "'" + valor.getContenebuque()+ "'";
            } else {
                categoria = categoria + "," + "'" + valor.getContenebuque()+ "'";
            }
            model.addValue("Total Contenedores por Buque", i, Integer.parseInt(valor.getSumcontenebuque()));
              i++;
        }
    ...
    public void Grafica2(String fecha_inicial, String fecha_final) throws SQLException {
        ...
        grafica2.setTitle("PORCENTAJE DE CONTENEDORES DE IMPORTACION POR BUQUE");
