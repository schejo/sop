...
import DAL.GraficaContenedoresExportDal;
...
import org.zkoss.zul.Div;
  ...
  public class GraficaContenedoresExportCtrl extends GenericForwardComposer {
    ...
    public void Grafica1(String Fecha_inicial, String Fecha_final) throws SQLException {
        GraficaContenedoresExportDal dataBase = new GraficaContenedoresExportDal();

        grafica1.setType("column");
        grafica1.setTitle("Contenedores de Exportacion por Linea");
        ...
        List<GraficaContenedoresExportMd> data = dataBase.Grafica1(Fecha_inicial, Fecha_final);
        String categoria = "";

        int i = 0;
        
        for (GraficaContenedoresExportMd valor : data) {
            if (categoria.equals("")) {
                categoria = "'" + valor.getConteneexport()+ "'";
            } else {
                categoria = categoria + "," + "'" + valor.getConteneexport()+ "'";
            }
            model.addValue("Total Contenedores de Exportacion por Linea", i, Integer.parseInt(valor.getSumaconteneexport()));
              i++;
        }
    ...
    public void Grafica2(String fecha_inicial, String fecha_final) throws SQLException {
        ...
        grafica2.setTitle("PORCENTAJE DE CONTENEDORES DE EXPORTACION POR LINEA");
