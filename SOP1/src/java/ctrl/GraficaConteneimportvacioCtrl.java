...
import DAL.GraficaConteneimportvacioDal;
...
import org.zkoss.zul.Div;
  ...
  public class GraficaConteneimportvacioCtrl extends GenericForwardComposer {
    ...
    public void Grafica1(String Fecha_inicial, String Fecha_final) throws SQLException {
        GraficaConteneimportvacioDal dataBase = new GraficaConteneimportvacioDal();

        grafica1.setType("column");
        grafica1.setTitle("Contenedores de Importacion Vacios");
        grafica1.setSubTitle("Fechas de Embarque "+Fecha_inicial +'-'+Fecha_final);
        ...
        List<GraficaConteneimportvacioMd> data = dataBase.Grafica1(Fecha_inicial, Fecha_final);
        String categoria = "";

        int i = 0;
        
        for (GraficaConteneimportvacioMd valor : data) {
            if (categoria.equals("")) {
                categoria = "'" + valor.getContenevacio()+ "'";
            } else {
                categoria = categoria + "," + "'" + valor.getContenevacio()+ "'";
            }
            model.addValue("Total Contenedores Vacios", i, Integer.parseInt(valor.getSumacontenevacio()));
              i++;
        }
    ...
    public void Grafica2(String fecha_inicial, String fecha_final) throws SQLException {
        ...
        grafica2.setTitle("PORCENTAJE CONTENEDORES VACIOS");
