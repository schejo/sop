...
import org.zkoss.zul.Div;
  ...
  public class GraficaBuques1Ctrl extends GenericForwardComposer {
    ...
    public void Grafica1(String Fecha_inicial, String Fecha_final) throws SQLException {
        GraficaBuques1Dal dataBase = new GraficaBuques1Dal();

        grafica1.setType("column");
        grafica1.setTitle("Tipos de Buques");
        ...
        List<GraficaBuques1Md> data = dataBase.Grafica1(Fecha_inicial, Fecha_final);
        String categoria = "";

        int i = 0;
        
        for (GraficaBuques1Md valor : data) {
            if (categoria.equals("")) {
    ...
    public void Grafica2(String fecha_inicial, String fecha_final) throws SQLException {
        ...
        grafica2.setTitle("TOTAL BUQUES POR TIPO");
