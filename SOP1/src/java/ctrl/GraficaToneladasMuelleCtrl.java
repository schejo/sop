...
import DAL.GraficaToneladasMuelleDal;
...
import org.zkoss.zul.Div;
  ...
  public class GraficaToneladasMuelleCtrl extends GenericForwardComposer {
    ...
    public void Grafica1(String Fecha_inicial, String Fecha_final) throws SQLException {
        GraficaToneladasMuelleDal dataBase = new GraficaToneladasMuelleDal();

        grafica1.setType("column");
        grafica1.setTitle("Buques por Toneladas por Muelle");
        ...
        List<GraficaToneladasMuelleMd> data = dataBase.Grafica1(Fecha_inicial, Fecha_final);
        String categoria = "";

        int i = 0;
        
        for (GraficaToneladasMuelleMd valor : data) {
            if (categoria.equals("")) {
                categoria = "'" + valor.getAnio()+ "'";
            } else {
                categoria = categoria + "," + "'" + valor.getAnio()+ "'";
            }
            // model.addValue("Toneladas por Muelle", i, Integer.parseInt(valor.getPeso()));
            model.addValue("Toneladas por Muelle", i, valor.getPeso());
              i++;
        }
    ...
    public void Grafica2(String fecha_inicial, String fecha_final) throws SQLException {
        ...
        grafica2.setTitle("PORCENTAJE TONELADA POR MUELLE");
