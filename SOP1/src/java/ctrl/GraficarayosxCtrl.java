...
import DAL.GraficarayosxDal;
import MD.GraficarayosxMd;
...
import org.zkoss.zul.Div;
  ...
  public class GraficarayosxCtrl extends GenericForwardComposer {
    ...
    public void Grafica1(String Fecha_inicial, String Fecha_final) throws SQLException {
        GraficarayosxDal dataBase = new GraficarayosxDal();

        grafica1.setType("column");
        grafica1.setTitle("Grafica de Contenedores por Rayos X");
        grafica1.setSubTitle("Fechas de Rayos X"+Fecha_inicial +'-'+Fecha_final);
        ...
        List<GraficarayosxMd> data = dataBase.Grafica1(Fecha_inicial, Fecha_final);
        String categoria = "";

        int i = 0;
        
        for (GraficarayosxMd valor : data) {
            if (categoria.equals("")) {
            ...
            model.addValue("Total de Contenedores por Rayos X", i,Integer.parseInt(valor.getCantidad()));
              i++;
        }
    ...
    public void Grafica2(String fecha_inicial, String fecha_final) throws SQLException {
        ...
        grafica2.setTitle("PORCENTAJE DE CONTENEDORES POR RAYOS X");
