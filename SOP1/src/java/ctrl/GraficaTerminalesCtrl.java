...
import DAL.GraficaTerminalesDal;
...
import org.zkoss.zul.Div;
  ...
  public class GraficaTerminalesCtrl extends GenericForwardComposer {
    ...
    public void Grafica1(String Fecha_inicial, String Fecha_final) throws SQLException {
        GraficaTerminalesDal dataBase = new GraficaTerminalesDal();

        grafica1.setType("column");
        grafica1.setTitle("Buques por Terminal");
        ...
        List<GraficaTerminalesMd> data = dataBase.Grafica1(Fecha_inicial, Fecha_final);
        String categoria = "";

        int i = 0;
        
        for (GraficaTerminalesMd valor : data) {
            if (categoria.equals("")) {
    ...
    public void Grafica2(String fecha_inicial, String fecha_final) throws SQLException {
        ...
        grafica2.setTitle("PORCENTAJE BUQUES POR TERMINAL");
