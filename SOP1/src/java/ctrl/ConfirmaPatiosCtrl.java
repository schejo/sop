 ...
 * @author Informatica
 */
public class ConfirmaPatiosCtrl extends GenericForwardComposer {
...
//        numArribo.setText("");
    ...
    public void onClick$btnGuardar(Event e) {
        ...
        if (contene.getText().equals("") || fecha.getText().equals("") || hora.getText().equals("")
                || ubica2.getText().equals("") || equipo.getText().equals("")
                || ubica.getSelectedItem().getValue().toString().equals("")) {
