...
//import ctrl.GraficaBuques1Ctrl;
...
import org.zkoss.zul.Div;
  ...
  public class GraficaCaladosCtrl extends GenericForwardComposer {
    ...
    public void Grafica1(String Fecha_inicial, String Fecha_final) throws SQLException {
        GraficaCaladosDal dataBase = new GraficaCaladosDal();

        grafica1.setType("column");
        grafica1.setTitle("Calados mayores de 11 metros por Terminal");
        ...
        List<GraficaCaladosMd> data = dataBase.Grafica1(Fecha_inicial, Fecha_final);
        String categoria = "";

        int i = 0;
        
        for (GraficaCaladosMd valor : data) {
            if (categoria.equals("")) {
                categoria = "'" + valor.getBuques()+ "'";
            } else {
                categoria = categoria + "," + "'" + valor.getBuques()+ "'";
            }
            model.addValue("Total por Buques", i, Integer.parseInt(valor.getSumabuques()));
              i++;
        }
    ...
    public void Grafica2(String fecha_inicial, String fecha_final) throws SQLException {
        ...
        grafica2.setTitle("PORCENTAJE CALADOS MAYORES DE 11 METROS POR TERMINAL");
