...
import DAL.GraficaConteneRefrimesDal;
...
import org.zkoss.zul.Div;
  ...
  public class GraficaConteneRefrimesCtrl extends GenericForwardComposer {
    ...
    public void Grafica1(String Fecha_inicial, String Fecha_final) throws SQLException {
        GraficaConteneRefrimesDal dataBase = new GraficaConteneRefrimesDal();

        grafica1.setType("column");
        grafica1.setTitle("Grafica de Contenedores Refrigerados por Mes");
        grafica1.setSubTitle("Fechas de Inicio y Final"+Fecha_inicial +'-'+Fecha_final);
        ...
        List<GraficaConteneRefrimesMd> data = dataBase.Grafica1(Fecha_inicial, Fecha_final);
        String categoria = "";

        int i = 0;
        
        for (GraficaConteneRefrimesMd valor : data) {
            if (categoria.equals("")) {
                categoria = "'" + valor.getMes()+ "'";
            } else {
                categoria = categoria + "," + "'" + valor.getMes()+ "'";
            }
            // model.addValue("Toneladas por Muelle", i, Integer.parseInt(valor.getPeso()));
            model.addValue("Total de Contenedores Refrigerados por Mes", i,Integer.parseInt(valor.getCantidad()));
              i++;
        }
    ...
    public void Grafica2(String fecha_inicial, String fecha_final) throws SQLException {
        ...
        grafica2.setTitle("PORCENTAJE DE CONTENEDORES REFRIGERADOS POR MES");
