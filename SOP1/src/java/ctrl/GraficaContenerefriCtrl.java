...
import DAL.GraficaContenerefriDal;
...
import org.zkoss.zul.Div;
  ...
  public class GraficaContenerefriCtrl extends GenericForwardComposer {
    ...
    public void Grafica1(String Fecha_inicial, String Fecha_final) throws SQLException {
        GraficaContenerefriDal dataBase = new GraficaContenerefriDal();

        grafica1.setType("column");
        grafica1.setTitle("Contenedores por Refrigeracion");
        grafica1.setSubTitle("Fechas de Conexion "+Fecha_inicial +'-'+Fecha_final);
        ...
        List<GraficaContenerefriMd> data = dataBase.Grafica1(Fecha_inicial, Fecha_final);
        String categoria = "";

        int i = 0;
        
        for (GraficaContenerefriMd valor : data) {
            if (categoria.equals("")) {
                categoria = "'" + valor.getContenedor()+ "'";
            } else {
                categoria = categoria + "," + "'" + valor.getContenedor()+ "'";
            }
            model.addValue("Total de Contenedores por Refrigeracion", i, Integer.parseInt(valor.getSumacontenedor()));
              i++;
        }
    ...
    public void Grafica2(String fecha_inicial, String fecha_final) throws SQLException {
        ...
        grafica2.setTitle("PORCENTAJE CONTENEDORES POR REFRIGERACION");
