...
import DAL.GraficaContenetransitoDal;
...
import org.zkoss.zul.Div;
  ...
  public class GraficaContenetransitoCtrl extends GenericForwardComposer {
    ...
    public void Grafica1(String Fecha_inicial, String Fecha_final) throws SQLException {
        GraficaContenetransitoDal dataBase = new GraficaContenetransitoDal();

        grafica1.setType("column");
        grafica1.setTitle("Contenedores por Transito");
        grafica1.setSubTitle("Fechas de Transito "+Fecha_inicial +'-'+Fecha_final);
        ...
        List<GraficaContenetransitoMd> data = dataBase.Grafica1(Fecha_inicial, Fecha_final);
        String categoria = "";

        int i = 0;
        
        for (GraficaContenetransitoMd valor : data) {
            if (categoria.equals("")) {
                categoria = "'" + valor.getContenetransito()+ "'";
            } else {
                categoria = categoria + "," + "'" + valor.getContenetransito()+ "'";
            }
            model.addValue("Total de Contenedores por Transito", i, Integer.parseInt(valor.getSumacontenetransito()));
              i++;
        }
    ...
    public void Grafica2(String fecha_inicial, String fecha_final) throws SQLException {
        ...
        grafica2.setTitle("PORCENTAJE CONTENEDORES POR TRANSITO");
