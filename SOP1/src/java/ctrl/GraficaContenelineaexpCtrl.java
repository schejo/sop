...
import DAL.GraficaContenelineaexpDal;
...
import org.zkoss.zul.Div;
  ...
  public class GraficaContenelineaexpCtrl extends GenericForwardComposer {
    ...
    public void Grafica1(String Fecha_inicial, String Fecha_final) throws SQLException {
        GraficaContenelineaexpDal dataBase = new GraficaContenelineaexpDal();
        ...
        List<GraficaContenelineaexpMd> data = dataBase.Grafica1(Fecha_inicial, Fecha_final);
        String categoria = "";

        int i = 0;
        
        for (GraficaContenelineaexpMd valor : data) {
            if (categoria.equals("")) {
