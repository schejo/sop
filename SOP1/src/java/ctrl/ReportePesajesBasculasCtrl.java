...
import DAL.ReportePesajesBasculasDal;
...
public class ReportePesajesBasculasCtrl extends GenericForwardComposer {
    ...
    public void ReporteExcel(String fechaInicio, String fechaFin) throws SQLException, IOException {
        ReportePesajesBasculasDal dataBase = new ReportePesajesBasculasDal();
        List<ReportePesajesBasculasMd> lista = dataBase.GetByFecha(fechaInicio, fechaFin);
       ...
       // Bitacora cc = new Bitacora();
        ...
        Sheet listSheet = workbook.createSheet("ReportePesajesBasculas");
        ...
        c2.setCellValue("REPORTE DE PESAJES DE BASCULAS");
        ...
        try {
            ...
            workbook.write(baos);
            AMedia amedia = new AMedia("ReporteDePesajesBasculas.xls", "xls", "application/file", baos.toByteArray());
