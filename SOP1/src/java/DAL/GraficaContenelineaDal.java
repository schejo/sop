...
public class GraficaContenelineaDal {

    public List<GraficaContenelineaMd> Grafica1(String sFecha_inicial, String sFecha_final) throws SQLException {
        List<GraficaContenelineaMd> lstDatos = new ArrayList<GraficaContenelineaMd>();
        ...
        try {
            ...
            while (rs.next()) {
                GraficaContenelineaMd temp = new GraficaContenelineaMd();
